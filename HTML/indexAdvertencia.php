...
<head>
    ...
    <title>Atualizar Advertência</title>
</head>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach($pdo->query($sql)as $row)
                        {
                            ...
                            echo '<td>'. $row['advertencia'] . '</td>';
                            echo '<td width=250>';
                            echo '<a class="btn btn-warning" href="registrarAdvertencia.php?id='.$row['id'].'">Atualizar</a>';
                            echo '</td>';
                            echo '</tr>';
                        }
                        Banco::desconectar();
